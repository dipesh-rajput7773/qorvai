  ...
  return (
    <motion.nav
      ...
      className={`fixed top-0 w-full z-50 transition-all duration-300 ${
        scrolled
          ? "py-4 bg-[#080807]/90 backdrop-blur-lg border-b border-[#2A2925]"
          : "py-6 bg-transparent"
      }`}
    >
      <div className="max-w-[1200px] mx-auto px-6 flex justify-between items-center">
        <Link
          href="/"
          className="flex items-center gap-3 font-display font-extrabold text-2xl tracking-tighter relative z-50"
        >
          <img
            src="/logo.png"
            alt="Qorvai Logo"
